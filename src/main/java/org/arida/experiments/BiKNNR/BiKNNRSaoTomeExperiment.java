...
public class BiKNNRSaoTomeExperiment {

	private BiKNNRSaoTomeExperiment() {
	...
	public static void main(String[] args) {
		...
		Logger logger = LoggerFactory.getLogger(BiKNNRSaoTomeExperiment.class);

		CHGraph testGraph = new GraphGenerator().generateSaoTome();
