...
public class BiKNNRSaintHelenaExperiment {

	private BiKNNRSaintHelenaExperiment() {
	...
	public static void main(String[] args) {
		...
		Logger logger = LoggerFactory.getLogger(BiKNNRSaintHelenaExperiment.class);

		CHGraph testGraph = new GraphGenerator().generateSaintHelena();
