...
public class VoronoiKNNSeychellesExperiment {

	private VoronoiKNNSeychellesExperiment() {
	...
	public static void main(String[] args) {
		...
		Logger logger = LoggerFactory.getLogger(VoronoiKNNSeychellesExperiment.class);

		int missedSeaches = 0;
		
		Graph testGraph = new GraphGenerator().generateSeychelles();
