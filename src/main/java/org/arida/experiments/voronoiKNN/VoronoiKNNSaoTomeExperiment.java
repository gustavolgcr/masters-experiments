...
public class VoronoiKNNSaoTomeExperiment {

	private VoronoiKNNSaoTomeExperiment() {
	...
	public static void main(String[] args) {
		...
		Logger logger = LoggerFactory.getLogger(VoronoiKNNSaoTomeExperiment.class);

		int missedSeaches = 0;
		
		Graph testGraph = new GraphGenerator().generateSaoTome();
